...
const translations = {
    es: {
        ...
        "tech-label": "Tecnologías:",
        "projects-title-5": "Modelo predictivo de mortabilidad e intubación en pacientes COVID-19",
        "projects-text-5": "Análisis estadístico y desarrollo de modelos de Machine Learning para predecir la mortalidad y la necesidad de intubación en pacientes hospitalizados con COVID-19, en colaboración con el Hospital Universitario Donostia (Osakidetza) y TECNUN (Universidad de Navarra). Se procesaron datos clínicos de 598 pacientes con 125 variables. Se realizó limpieza de datos, imputación de valores faltantes por media por grupo de edad, feature engineering (IMC, índice de oxigenación, ciclo vital) y selección de variables mediante el criterio AIC. Los modelos finales se entrenaron con Regresión Logística, alcanzando un AUC-ROC de 0,92 en el modelo de mortalidad. Los resultados se visualizan en un dashboard interactivo construido con Dash.",
        "tech-label": "Tecnologías:",
